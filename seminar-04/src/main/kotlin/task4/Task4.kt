 ...
 */
data class Decision(val question: String, val answerLeft: String, val answerRight: String): CostElement {
 ...
 */
data class SetIntersection<T: Comparable<T>>(
